...
import {
  Card, Row, Col, Statistic, Empty, Spin, Typography, Table, Button, Popconfirm, message
} from 'antd';
import {
  DollarOutlined, ShoppingCartOutlined, PercentageOutlined, EyeOutlined, DeleteOutlined
...
export default function BusinessAnalysis() {
  ...
  const handleDelete = async (record) => {
    ...
    try {
      await db.businessReports.delete(record.id);
