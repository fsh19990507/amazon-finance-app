...
export default function ExpenseAnalysis() {
      ...
      series: [
        {
          ...
          data: expenseItems.map((it) => ({
            ...
            itemStyle: {
              color: it.group === '广告花费' ? '#cf1322' :
                it.group === '订单支出' ? '#1890ff' :
                it.group === '推广费' ? '#722ed1' :
                it.group === '其余服务费' ? '#fa8c16' :
                it.group === '采购成本' ? '#8c8c8c' : '#13c2c2',
      ...
      series: [
        {
          ...
          itemStyle: { color: '#1e3a5f' }, lineStyle: { width: 2 },
          markLine: {
            silent: true,
  ...
  }, [sortedReports, selectedKey, rate]);
