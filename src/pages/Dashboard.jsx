...
import { useECharts, buildWaterfallOption, buildCalendarHeatmapOption, CHART_COLORS } from '../utils/useECharts.js';
      ...
      series: [
        {
          ...
          areaStyle: { opacity: 0.1, color: '#3f8600' },
        ...
        },
        {
          ...
          areaStyle: { opacity: 0.1, color: '#cf1322' },
          markLine: { data: [], silent: true }
        },
        {
          name: '毛利润', type: 'line',
