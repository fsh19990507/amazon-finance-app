  ...
  return (
    <div>
      <Alert
        type="info"
        showIcon
        message="主题包含菜单选中态、按钮、图标、图表配色全套样式"
          ...
          return (
            <Col xs={12} sm={8} key={t.id}>
              <Card
                ...
                style={{
                  // 选中态：主题主色边框 + 角标
                  border: selected ? `2px solid ${t.token.colorPrimary}` : '1px solid #f0f0f0',
                  cursor: 'pointer',
                  position: 'relative',
                  overflow: 'hidden'
                }}
              ...
              >
                ...
                <div style={{
                  height: 56,
                  borderRadius: 4,
                  background: t.extended.sidebarGradient,
                  marginBottom: 10
                }} />
                <div style={{ textAlign: 'center', fontWeight: 500 }}>{t.name}</div>
                <div style={{ textAlign: 'center', fontSize: 12, color: '#8c8c8c', marginTop: 2 }}>
                  {t.isDark ? '暗色主题' : '亮色主题'}
                </div>
              </Card>
            </Col>
...
function StoreManager() {
  ...
  return (
    <div>
      ...
      <Table rowKey="id" columns={columns} dataSource={stores} size="small" pagination={false} scroll={{ x: 700 }} />
